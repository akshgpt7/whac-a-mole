...
hole1=Button(width=6,height=3,bg='black',state='disabled',command=onwhack)
hole1.place(x=20,y=160)
hole2=Button(width=6,height=3,bg='black',state='disabled',command=onwhack)
hole2.place(x=20,y=290)
hole3=Button(width=6,height=3,bg='black',state='disabled',command=onwhack)
hole3.place(x=20,y=420)
hole4=Button(width=6,height=3,bg='black',state='disabled',command=onwhack)
hole4.place(x=220,y=160)
hole5=Button(width=6,height=3,bg='black',state='disabled',command=onwhack)
hole5.place(x=220,y=290)
hole6=Button(width=6,height=3,bg='black',state='disabled',command=onwhack)
hole6.place(x=220,y=420)
hole7=Button(width=6,height=3,bg='black',state='disabled',command=onwhack)
hole7.place(x=420,y=160)
hole8=Button(width=6,height=3,bg='black',state='disabled',command=onwhack)
hole8.place(x=420,y=290)
hole9=Button(width=6,height=3,bg='black',state='disabled',command=onwhack)
...
def whac_a_mole():
    ...
    for i in range(0,60):
        ...
        if hole==1:
            hole1.config(state='normal',text='【•】__【•】',bg='pink',fg='black')
            sleep(1)
            hole1.config(state='disabled',text='',bg='black')
        elif hole==2:
            hole2.config(state='normal',text='【•】__【•】',bg='pink',fg='black')
            sleep(1)
            hole2.config(state='disabled',text='',bg='black')
        elif hole==3:
            hole3.config(state='normal',text='【•】__【•】',bg='pink',fg='black')
            sleep(1)
            hole3.config(state='disabled',text='',bg='black')
        elif hole==4:
            hole4.config(state='normal',text='【•】__【•】',bg='pink',fg='black')
            sleep(1)
            hole4.config(state='disabled',text='',bg='black')
        elif hole==5:
            hole5.config(state='normal',text='【•】__【•】',bg='pink',fg='black')
            sleep(1)
            hole5.config(state='disabled',text='',bg='black')
        elif hole==6:
            hole6.config(state='normal',text='【•】__【•】',bg='pink',fg='black')
            sleep(1)
            hole6.config(state='disabled',text='',bg='black')
        elif hole==7:
            hole7.config(state='normal',text='【•】__【•】',bg='pink',fg='black')
            sleep(1)
            hole7.config(state='disabled',text='',bg='black')
        elif hole==8:
            hole8.config(state='normal',text='【•】__【•】',bg='pink',fg='black')
            sleep(1)
            hole8.config(state='disabled',text='',bg='black')
        elif hole==9:
            hole9.config(state='normal',text='【•】__【•】',bg='pink',fg='black')
            sleep(1)
